...
public class MainClass {
    public static void main(String[] args) {
        ...
        try {
            ...
            session.save(author);   // // INSERT INTO authors (name) VALUES ('Rowling')
...
//            READ
            ...
            session.getTransaction().commit();    // // SELECT * FROM books WHERE id = 1
...
//            UPDATE
            ...
            session.getTransaction().commit();    // // UPDATE books SET title = '...' WHERE id = 3
...
//            Delete
            ...
            session.delete(author);   // // DELETE FROM books WHERE id = 4
            session.getTransaction().commit();
        } finally {
            factory.close();
            session.close();
